...
\resumeSubHeadingListStart
\resumeSubheading
{Senior Software Engineer}{Feb 2022 -- Present}
{Qantas}{Melbourne, Vic}
\resumeItemListStart
\resumeItem{Migrating backend services to use newly implemented REST APIs from SOAP}
\resumeItem{Built lambda functions to automate weekly/monthly tasks performed manually}
\resumeItem{Extend APIs built in Clojure to support different ways of paying with qantas loyalty points}
\resumeItemListEnd
...
\resumeItem{Building a KYC service based on existing services to extend our BNPL product to the NZ market}
...
\resumeItem{Mentoring junior developers via pair programming sessions and running a small workshop on TDD which we use throughout Latitude}
\resumeItemListEnd
